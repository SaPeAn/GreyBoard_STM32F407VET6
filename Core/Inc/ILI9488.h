...
#define CS_PIN		DISP_CS_Pin //Chip select
#define RESX_PORT	DISP_RST_GPIO_Port
#define RESX_PIN	DISP_RST_Pin //Reset pin
#define	DC_PORT		DISP_DC_GPIO_Port
#define DC_PIN		DISP_DC_Pin //DATA / Command select
